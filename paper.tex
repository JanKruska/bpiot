...
The resulting times are shown in \cref{fig:scalability}\footnote{Note that when two logs of size $n$ are compared, $n^2$ comparisons are needed. This is the reason why the needed time scales quadratically with log size}.
