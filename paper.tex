...
In the last two decades more and more devices and specifically controller for devices have moved from implementions in hardware to implementations in software.
Additionally as the cost for networking components has shrunk more and more of these devices have some networking capabilities, e.g. in the form of IP, bluetooth or RFID.
This vast infrastructure of small networked devices is fertile ground for process analysis.
...
This is especially interesting in the case of automation in manufacturing for which the term Internet of Production has been coined.
Here fully digitized networked control systems and the information pooling and sharing thos bring with it could greatly enhance the production capabilities of not just single production lines but entire automated factories.
Both these "Internet"'s\footnote{Note that there will not be a very clear distinction between these two terms in this paper. The object of interest here is a highly distributed networks of interacting devices, that generate a large amount of event data about their surroundings. Which specific environment they are in, is  of lesser importance here.} 
constitute a highly digitized network in which vast amounts of data, including event data, are being generated and measured.
Especially in the case of manufacturing there is a large financial interest in optimizing production pipelines.
...
As such there is research demand for different -- to test whether algorithms perform equally well in other scenarios --, larger -- to improve scalability of algorithms -- and more complex -- to test and improve the capacity to deal with more interwoven processes -- problems.
