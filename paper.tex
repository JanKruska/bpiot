...
The first set of experiments focussed on the scalability of the approach, the second aimed to assess the the effect of applying noise to a log and comparing that to the noiseless log.
...
Then fitness and precision between the discovered model and the real log were calculated using the previously mentioned algorithms aswell as the method described in the paper.
