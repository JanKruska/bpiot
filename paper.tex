...
\color{blue}
Given two logs, one real and one produced by replaying the model, it is first necessary to train the \emph{act2vec}\cite{KBWe18} embedding.
\color{black}
\subsection{act2vec}
...
In the paper the cosine similarity \todo{formula?} was chosen for its simplicity and the fact that it is bounded in the interval $[-1,1]$.
...
\todo{Explain more how process trees were generated}
